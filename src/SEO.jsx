...
const SEO = ({
  ...
  siteName = "MK Globale Services", // <== Nom de ton site/projet (en général, tu peux laisser comme ça)
  twitterHandle = "@MKGS",// <== Twitter handle, à mettre si tu as un compte (sinon tu modifies)
  ...
  <Helmet>
    ...
    <meta name="author" content="Alpha ousmane diallo" /> {/* <= Auteur global */}
    <meta name="copyright" content="Mk Globale Services-gn 2025" />
    ...
    <script type="application/ld+json">
      {JSON.stringify({
        ...
        "contactPoint": [
          {
            "@type": "ContactPoint",
            "telephone": "+224 622 856 693", // <= Numéro de contact principal, PERSONNALISE
            "contactType": "customer service",
            "areaServed": "GN"               // <= GN = Guinée. Modifie si international.
          }
        ],
        "sameAs": [
          "https://www.facebook.com/mk", // <= Met tes liens officiels
          "https://www.linkedin.com/company/mkgservices-gn"
        ]
      })}
    </script>
